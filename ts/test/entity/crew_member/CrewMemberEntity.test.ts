...
describe('CrewMemberEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'crew_member.' + op, live)) return
    }
    ...
    let crew_member_ref01_data = Object.values(setup.data.existing.crew_member)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/crew_member/CrewMemberTestData.json')
