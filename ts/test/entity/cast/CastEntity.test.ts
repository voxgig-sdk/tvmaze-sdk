...
describe('CastEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'cast.' + op, live)) return
    }
    ...
    let cast_ref01_data = Object.values(setup.data.existing.cast)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/cast/CastTestData.json')
