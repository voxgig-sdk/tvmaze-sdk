...
//     (\`new TvmazeSDK(...)\` / \`TvmazeSDK.test(...)\` become
//     \`TvmazeSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"aka":{"test01":{"id":"test01"}},"alternate_list":{"test01":{"id":"test01"}},"cast":{"test01":{"id":"test01"}},"cast_credit":{"test01":{"id":"test01"}},"cast_member":{"test01":{"id":"test01"}},"crew":{"test01":{"id":"test01"}},"crew_credit":{"test01":{"id":"test01"}},"crew_member":{"test01":{"id":"test01"}},"episode":{"test01":{"id":"test01"}},"guest_cast_credit":{"test01":{"id":"test01"}},"image":{"test01":{"id":"test01"}},"person":{"test01":{"id":"test01"}},"schedule":{"test01":{"id":"test01"}},"scheduled_episode":{"test01":{"id":"test01"}},"search":{"test01":{"id":"test01"}},"season":{"test01":{"id":"test01"}},"show":{"test01":{"id":"test01"}},"update":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new TvmazeSDK(...)\` and any
// \`TvmazeSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+TvmazeSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/TvmazeSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
