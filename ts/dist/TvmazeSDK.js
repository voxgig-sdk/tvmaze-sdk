...
exports.SDK = exports.TvmazeSDK = exports.TvmazeEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const AkaEntity_1 = require("./entity/AkaEntity");
const AlternateListEntity_1 = require("./entity/AlternateListEntity");
const CastEntity_1 = require("./entity/CastEntity");
const CastCreditEntity_1 = require("./entity/CastCreditEntity");
const CastMemberEntity_1 = require("./entity/CastMemberEntity");
const CrewEntity_1 = require("./entity/CrewEntity");
const CrewCreditEntity_1 = require("./entity/CrewCreditEntity");
const CrewMemberEntity_1 = require("./entity/CrewMemberEntity");
const EpisodeEntity_1 = require("./entity/EpisodeEntity");
const GuestCastCreditEntity_1 = require("./entity/GuestCastCreditEntity");
...
const ScheduledEpisodeEntity_1 = require("./entity/ScheduledEpisodeEntity");
const SearchEntity_1 = require("./entity/SearchEntity");
const SeasonEntity_1 = require("./entity/SeasonEntity");
const ShowEntity_1 = require("./entity/ShowEntity");
const UpdateEntity_1 = require("./entity/UpdateEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const TvmazeEntityBase_1 = require("./TvmazeEntityBase");
Object.defineProperty(exports, "TvmazeEntityBase", { enumerable: true, get: function () { return TvmazeEntityBase_1.TvmazeEntityBase; } });
...
class TvmazeSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('TvmazeSDK: graphql: ' +
    ...
    Aka(entopts) {
        const self = this;
        return new AkaEntity_1.AkaEntity(self, entopts);
    }
    // Entity access: `client.AlternateList().list()` / `client.AlternateList().load({ id })`.
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    AlternateList(entopts) {
        const self = this;
        return new AlternateListEntity_1.AlternateListEntity(self, entopts);
    }
    ...
    Cast(entopts) {
        const self = this;
        return new CastEntity_1.CastEntity(self, entopts);
    }
    ...
    CastCredit(entopts) {
        const self = this;
        return new CastCreditEntity_1.CastCreditEntity(self, entopts);
    }
    ...
    CastMember(entopts) {
        const self = this;
        return new CastMemberEntity_1.CastMemberEntity(self, entopts);
    }
    ...
    CrewCredit(entopts) {
        const self = this;
        return new CrewCreditEntity_1.CrewCreditEntity(self, entopts);
    }
    ...
    CrewMember(entopts) {
        const self = this;
        return new CrewMemberEntity_1.CrewMemberEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    GuestCastCredit(entopts) {
        const self = this;
        return new GuestCastCreditEntity_1.GuestCastCreditEntity(self, entopts);
    }
    ...
    // The argument is the entity OPTIONS object (passed to the entity
    // constructor as entopts), not initial entity data.
    ScheduledEpisode(entopts) {
        const self = this;
        return new ScheduledEpisodeEntity_1.ScheduledEpisodeEntity(self, entopts);
    }
    ...
    Season(entopts) {
        const self = this;
        return new SeasonEntity_1.SeasonEntity(self, entopts);
    }
    ...
    Show(entopts) {
        const self = this;
        return new ShowEntity_1.ShowEntity(self, entopts);
    }
...
exports.TvmazeSDK = TvmazeSDK;
const SDK = TvmazeSDK;
exports.SDK = SDK;
//# sourceMappingURL=TvmazeSDK.js.map