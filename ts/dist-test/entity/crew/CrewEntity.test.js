...
(0, node_test_1.describe)('CrewEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        crew_ref01_match['show_id'] = setup.idmap['show01'];
...
function basicSetup(extra) {
    ...
    let idmap = transform(['crew01', 'crew02', 'crew03', 'show01', 'show02', 'show03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TVMAZE_TEST_CREW_ENTID'];
    ...
    idmap = env['TVMAZE_TEST_CREW_ENTID'];
