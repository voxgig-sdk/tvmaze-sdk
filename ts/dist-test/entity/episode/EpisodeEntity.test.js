...
(0, node_test_1.describe)('EpisodeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TVMAZE_TEST_EPISODE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['episode01', 'episode02', 'episode03', 'season01', 'season02', 'season03', 'show01', 'show02', 'show03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TVMAZE_TEST_EPISODE_ENTID'];
    ...
    idmap = env['TVMAZE_TEST_EPISODE_ENTID'];
