...
(0, node_test_1.describe)('CastDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-cast', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cast', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_CAST_ENTID'];
...
//# sourceMappingURL=CastDirect.test.js.map