...
(0, node_test_1.describe)('SeasonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-season', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-season', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_SEASON_ENTID'];
...
//# sourceMappingURL=SeasonDirect.test.js.map