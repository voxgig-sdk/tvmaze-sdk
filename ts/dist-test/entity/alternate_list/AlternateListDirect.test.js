...
(0, node_test_1.describe)('AlternateListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-alternate_list', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-alternate_list', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-alternate_list', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-alternate_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["show01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_ALTERNATE_LIST_ENTID'];
...
//# sourceMappingURL=AlternateListDirect.test.js.map