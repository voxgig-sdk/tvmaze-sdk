...
(0, node_test_1.describe)('ImageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TVMAZE_TEST_IMAGE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['image01', 'image02', 'image03', 'show01', 'show02', 'show03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TVMAZE_TEST_IMAGE_ENTID'];
    ...
    idmap = env['TVMAZE_TEST_IMAGE_ENTID'];
