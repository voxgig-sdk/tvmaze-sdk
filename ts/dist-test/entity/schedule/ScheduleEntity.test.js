...
(0, node_test_1.describe)('ScheduleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TVMAZE_TEST_SCHEDULE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TVMAZE_TEST_SCHEDULE_ENTID'];
    ...
    idmap = env['TVMAZE_TEST_SCHEDULE_ENTID'];
