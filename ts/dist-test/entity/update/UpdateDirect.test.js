...
(0, node_test_1.describe)('UpdateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-update', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-update', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_UPDATE_ENTID'];
