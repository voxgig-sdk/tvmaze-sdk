...
(0, node_test_1.describe)('GuestCastCreditDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-guest_cast_credit', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-guest_cast_credit', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_GUEST_CAST_CREDIT_ENTID'];
...
//# sourceMappingURL=GuestCastCreditDirect.test.js.map