...
(0, node_test_1.describe)('AkaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-aka', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-aka', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_AKA_ENTID'];
...
//# sourceMappingURL=AkaDirect.test.js.map