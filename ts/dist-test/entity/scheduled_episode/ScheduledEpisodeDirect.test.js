...
(0, node_test_1.describe)('ScheduledEpisodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-scheduled_episode', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-scheduled_episode', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TVMAZE_TEST_SCHEDULED_EPISODE_ENTID'];
...
//# sourceMappingURL=ScheduledEpisodeDirect.test.js.map