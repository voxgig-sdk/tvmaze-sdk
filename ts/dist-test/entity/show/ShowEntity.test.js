...
(0, node_test_1.describe)('ShowEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'show.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['show01', 'show02', 'show03', 'alternatelist01', 'alternatelist02', 'alternatelist03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TVMAZE_TEST_SHOW_ENTID'];
    ...
    idmap = env['TVMAZE_TEST_SHOW_ENTID'];
