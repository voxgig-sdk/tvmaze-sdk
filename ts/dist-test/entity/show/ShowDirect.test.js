...
(0, node_test_1.describe)('ShowDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-show', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-show', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    alternatelist_id: setup.idmap['alternatelist01'],
                },
            });
            if (!listResult.ok) {
    ...
    (0, node_test_1.test)('direct-list-show', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-show', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["alternatelist01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TvmazeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['TVMAZE_TEST_SHOW_ENTID'];
    ...
    const client = new __1.TvmazeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ShowDirect.test.js.map