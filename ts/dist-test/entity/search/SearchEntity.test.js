...
(0, node_test_1.describe)('SearchEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TVMAZE_TEST_SEARCH_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TVMAZE_TEST_SEARCH_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'TVMAZE_TEST_SEARCH_ENTID': idmap,
        'TVMAZE_TEST_LIVE': 'FALSE',
        'TVMAZE_TEST_EXPLAIN': 'FALSE',
    });
    idmap = env['TVMAZE_TEST_SEARCH_ENTID'];
