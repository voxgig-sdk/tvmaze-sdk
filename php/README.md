...
The PHP SDK for the Tvmaze API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Aka(null)->list(null, null);
...
[$result, $err] = $client->Tvmaze(null)->load(
    ["id" => "test01"], null
);
