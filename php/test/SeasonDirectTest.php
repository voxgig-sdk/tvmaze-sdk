...
class SeasonDirectTest extends TestCase
{
    public function test_direct_list_season(): void
    {
        $setup = season_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-season", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
