...
// Tvmaze SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TvmazeSDK::test)
...
{
    private const SDK_CLASS = 'TvmazeSDK';
    ...
    private const SDK_BASE = 'tvmaze_sdk';
