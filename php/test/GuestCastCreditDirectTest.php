...
class GuestCastCreditDirectTest extends TestCase
{
    public function test_direct_list_guest_cast_credit(): void
    {
        $setup = guest_cast_credit_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-guest_cast_credit", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
