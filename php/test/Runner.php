...
class TvmazeTestRunner
{
    ...
    {
        $live = self::getenv('TVMAZE_TEST_LIVE');
        $override = self::getenv('TVMAZE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TVMAZE_TEST_EXPLAIN');
...
class_alias('TvmazeTestRunner', 'Runner');
class_alias('TvmazeHelpers', 'Helpers');
