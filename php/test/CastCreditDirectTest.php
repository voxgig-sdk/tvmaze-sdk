...
class CastCreditDirectTest extends TestCase
{
    public function test_direct_list_cast_credit(): void
    {
        $setup = cast_credit_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cast_credit", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
