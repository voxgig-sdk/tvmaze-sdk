...
class AkaDirectTest extends TestCase
{
    public function test_direct_list_aka(): void
    {
        $setup = aka_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-aka", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
