...
class CastDirectTest extends TestCase
{
    public function test_direct_list_cast(): void
    {
        $setup = cast_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cast", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
