...
class CrewCreditEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CrewCreditEntity($this->_client, $opts);
    }

    /**
     * @param CrewCredit|array $args CrewCredit data (assoc-array) to store.
     */
    ...
    /**
     * @return CrewCredit|array The current CrewCredit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CrewCredit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CrewCredit fields).
     */
     ...
     *
     * @param CrewCreditListMatch|array|null $reqmatch Match filter (any subset
     *   of CrewCredit fields) as an assoc-array; CrewCreditListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CrewCredit[]|array A list of CrewCredit items as assoc-arrays at
