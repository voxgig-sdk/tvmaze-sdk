...
// Tvmaze SDK ScheduledEpisode entity
...
class ScheduledEpisodeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ScheduledEpisodeEntity($this->_client, $opts);
    }

    /**
     * @param ScheduledEpisode|array $args ScheduledEpisode data (assoc-array) to store.
     */
    ...
    /**
     * @return ScheduledEpisode|array The current ScheduledEpisode data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ScheduledEpisode fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ScheduledEpisode fields).
     */
    ...
    /**
     * List ScheduledEpisode items matching the given filter.
     *
     * @param ScheduledEpisodeListMatch|array|null $reqmatch Match filter (any subset
     *   of ScheduledEpisode fields) as an assoc-array; ScheduledEpisodeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ScheduledEpisode[]|array A list of ScheduledEpisode items as assoc-arrays at
