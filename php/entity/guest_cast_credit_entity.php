...
// Tvmaze SDK GuestCastCredit entity
...
class GuestCastCreditEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GuestCastCreditEntity($this->_client, $opts);
    }

    /**
     * @param GuestCastCredit|array $args GuestCastCredit data (assoc-array) to store.
     */
    ...
    /**
     * @return GuestCastCredit|array The current GuestCastCredit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GuestCastCredit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GuestCastCredit fields).
     */
    ...
    /**
     * List GuestCastCredit items matching the given filter.
     *
     * @param GuestCastCreditListMatch|array|null $reqmatch Match filter (any subset
     *   of GuestCastCredit fields) as an assoc-array; GuestCastCreditListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GuestCastCredit[]|array A list of GuestCastCredit items as assoc-arrays at
