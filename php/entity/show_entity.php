...
class ShowEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShowEntity($this->_client, $opts);
    }

    /**
     * @param Show|array $args Show data (assoc-array) to store.
     */
    ...
    /**
     * @return Show|array The current Show data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Show fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Show fields).
     */
     ...
     * Load a single Show.
     *
     * @param ShowLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ShowLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Show|array The loaded Show as an assoc-array at the
    ...
    /**
     * List Show items matching the given filter.
     *
     * @param ShowListMatch|array|null $reqmatch Match filter (any subset
     *   of Show fields) as an assoc-array; ShowListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Show[]|array A list of Show items as assoc-arrays at
