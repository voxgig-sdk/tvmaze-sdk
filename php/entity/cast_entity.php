...
class CastEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CastEntity($this->_client, $opts);
    }

    /**
     * @param Cast|array $args Cast data (assoc-array) to store.
     */
    ...
    /**
     * @return Cast|array The current Cast data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cast fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cast fields).
     */
    ...
    /**
     * List Cast items matching the given filter.
     *
     * @param CastListMatch|array|null $reqmatch Match filter (any subset
     *   of Cast fields) as an assoc-array; CastListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cast[]|array A list of Cast items as assoc-arrays at
