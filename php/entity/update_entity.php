...
class UpdateEntity
{
     ...
     *
     * @param UpdateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UpdateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Update|array The loaded Update as an assoc-array at the
