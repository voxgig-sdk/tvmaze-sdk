...
class AkaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AkaEntity($this->_client, $opts);
    }

    /**
     * @param Aka|array $args Aka data (assoc-array) to store.
     */
    ...
    /**
     * @return Aka|array The current Aka data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Aka fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Aka fields).
     */
     ...
     *
     * @param AkaListMatch|array|null $reqmatch Match filter (any subset
     *   of Aka fields) as an assoc-array; AkaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Aka[]|array A list of Aka items as assoc-arrays at
