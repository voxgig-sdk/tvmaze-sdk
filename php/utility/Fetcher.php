...
class TvmazeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TvmazeSDK/1.0)';
    ...
    public static function call(TvmazeContext $ctx, string $fullurl, array $fetchdef): array
    {
