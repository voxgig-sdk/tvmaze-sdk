...
class TvmazeRbacFeature extends TvmazeBaseFeature
{
    ...
    private function _required(TvmazeContext $ctx): ?string
    {
    ...
    private function _reject(TvmazeContext $ctx, string $required): void
    {
    ...
    private function _track(TvmazeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
