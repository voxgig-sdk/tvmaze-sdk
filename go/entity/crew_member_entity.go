...
func NewCrewMemberEntity(client *core.TvmazeSDK, entopts map[string]any) *CrewMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CrewMemberEntity) GetName() string { return e.name }
...
func (e *CrewMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CrewMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *CrewMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCrewMemberEntity(e.client, opts)
}

func (e *CrewMemberEntity) Data(args ...any) any {
...
func (e *CrewMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CrewMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CrewMemberEntity) DataTyped(data ...CrewMember) CrewMember {
	if len(data) > 0 {
		return typedFrom[CrewMember](e.Data(asMap(data[0])))
	}
	return typedFrom[CrewMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CrewMember (all fields
// optional at the wire level).
func (e *CrewMemberEntity) MatchTyped(match ...CrewMember) CrewMember {
	if len(match) > 0 {
		return typedFrom[CrewMember](e.Match(asMap(match[0])))
	}
	return typedFrom[CrewMember](e.Match())
}
...
func (e *CrewMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CrewMemberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CrewMemberEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CrewMemberListMatch and returns []CrewMember. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CrewMemberEntity) ListTyped(reqmatch CrewMemberListMatch, ctrl map[string]any) ([]CrewMember, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CrewMember](res), nil
}



func (e *CrewMemberEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CrewMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CrewMemberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CrewMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
