...
func NewCastMemberEntity(client *core.TvmazeSDK, entopts map[string]any) *CastMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CastMemberEntity) GetName() string { return e.name }
...
func (e *CastMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CastMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *CastMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCastMemberEntity(e.client, opts)
}

func (e *CastMemberEntity) Data(args ...any) any {
...
func (e *CastMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CastMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CastMemberEntity) DataTyped(data ...CastMember) CastMember {
	if len(data) > 0 {
		return typedFrom[CastMember](e.Data(asMap(data[0])))
	}
	return typedFrom[CastMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CastMember (all fields
// optional at the wire level).
func (e *CastMemberEntity) MatchTyped(match ...CastMember) CastMember {
	if len(match) > 0 {
		return typedFrom[CastMember](e.Match(asMap(match[0])))
	}
	return typedFrom[CastMember](e.Match())
}
...
func (e *CastMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CastMemberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CastMemberEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CastMemberListMatch and returns []CastMember. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CastMemberEntity) ListTyped(reqmatch CastMemberListMatch, ctrl map[string]any) ([]CastMember, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CastMember](res), nil
}



func (e *CastMemberEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CastMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CastMemberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CastMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
