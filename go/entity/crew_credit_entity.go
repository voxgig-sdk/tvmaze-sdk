...
func NewCrewCreditEntity(client *core.TvmazeSDK, entopts map[string]any) *CrewCreditEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CrewCreditEntity) GetName() string { return e.name }
...
func (e *CrewCreditEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CrewCreditEntity) Deleted() bool {
	return e.deleted
}


func (e *CrewCreditEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCrewCreditEntity(e.client, opts)
}

func (e *CrewCreditEntity) Data(args ...any) any {
...
func (e *CrewCreditEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CrewCredit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CrewCreditEntity) DataTyped(data ...CrewCredit) CrewCredit {
	if len(data) > 0 {
		return typedFrom[CrewCredit](e.Data(asMap(data[0])))
	}
	return typedFrom[CrewCredit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CrewCredit (all fields
// optional at the wire level).
func (e *CrewCreditEntity) MatchTyped(match ...CrewCredit) CrewCredit {
	if len(match) > 0 {
		return typedFrom[CrewCredit](e.Match(asMap(match[0])))
	}
	return typedFrom[CrewCredit](e.Match())
}
...
func (e *CrewCreditEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CrewCreditEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CrewCreditEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CrewCreditListMatch and returns []CrewCredit. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CrewCreditEntity) ListTyped(reqmatch CrewCreditListMatch, ctrl map[string]any) ([]CrewCredit, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CrewCredit](res), nil
}



func (e *CrewCreditEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CrewCreditEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CrewCreditEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CrewCreditEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
