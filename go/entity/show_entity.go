...
func NewShowEntity(client *core.TvmazeSDK, entopts map[string]any) *ShowEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShowEntity) GetName() string { return e.name }
...
func (e *ShowEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShowEntity) Deleted() bool {
	return e.deleted
}


func (e *ShowEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShowEntity(e.client, opts)
}

func (e *ShowEntity) Data(args ...any) any {
...
func (e *ShowEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Show; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShowEntity) DataTyped(data ...Show) Show {
	if len(data) > 0 {
		return typedFrom[Show](e.Data(asMap(data[0])))
	}
	return typedFrom[Show](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Show (all fields
// optional at the wire level).
func (e *ShowEntity) MatchTyped(match ...Show) Show {
	if len(match) > 0 {
		return typedFrom[Show](e.Match(asMap(match[0])))
	}
	return typedFrom[Show](e.Match())
}
...
func (e *ShowEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShowEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShowLoadMatch and returns an Show. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ShowEntity) LoadTyped(reqmatch ShowLoadMatch, ctrl map[string]any) (Show, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Show{}, err
	}
	return typedFrom[Show](res), nil
}




func (e *ShowEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ShowListMatch and returns []Show. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ShowEntity) ListTyped(reqmatch ShowListMatch, ctrl map[string]any) ([]Show, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Show](res), nil
}



func (e *ShowEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShowEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShowEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShowEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
