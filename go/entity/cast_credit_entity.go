...
func NewCastCreditEntity(client *core.TvmazeSDK, entopts map[string]any) *CastCreditEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CastCreditEntity) GetName() string { return e.name }
...
func (e *CastCreditEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CastCreditEntity) Deleted() bool {
	return e.deleted
}


func (e *CastCreditEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCastCreditEntity(e.client, opts)
}

func (e *CastCreditEntity) Data(args ...any) any {
...
func (e *CastCreditEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CastCreditEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CastCreditEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *CastCreditEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CastCreditEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CastCreditEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CastCreditEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
