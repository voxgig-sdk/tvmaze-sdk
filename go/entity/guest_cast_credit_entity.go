...
type GuestCastCreditEntity struct {
	name    string
...
func NewGuestCastCreditEntity(client *core.TvmazeSDK, entopts map[string]any) *GuestCastCreditEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GuestCastCreditEntity) GetName() string { return e.name }
...
func (e *GuestCastCreditEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GuestCastCreditEntity) Deleted() bool {
	return e.deleted
}


func (e *GuestCastCreditEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGuestCastCreditEntity(e.client, opts)
}

func (e *GuestCastCreditEntity) Data(args ...any) any {
...
func (e *GuestCastCreditEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GuestCastCredit; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GuestCastCreditEntity) DataTyped(data ...GuestCastCredit) GuestCastCredit {
	if len(data) > 0 {
		return typedFrom[GuestCastCredit](e.Data(asMap(data[0])))
	}
	return typedFrom[GuestCastCredit](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GuestCastCredit (all fields
// optional at the wire level).
func (e *GuestCastCreditEntity) MatchTyped(match ...GuestCastCredit) GuestCastCredit {
	if len(match) > 0 {
		return typedFrom[GuestCastCredit](e.Match(asMap(match[0])))
	}
	return typedFrom[GuestCastCredit](e.Match())
}
...
func (e *GuestCastCreditEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GuestCastCreditEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GuestCastCreditEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GuestCastCreditListMatch and returns []GuestCastCredit. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GuestCastCreditEntity) ListTyped(reqmatch GuestCastCreditListMatch, ctrl map[string]any) ([]GuestCastCredit, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GuestCastCredit](res), nil
}



func (e *GuestCastCreditEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GuestCastCreditEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GuestCastCreditEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GuestCastCreditEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
