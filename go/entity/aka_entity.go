...
func NewAkaEntity(client *core.TvmazeSDK, entopts map[string]any) *AkaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AkaEntity) GetName() string { return e.name }
...
func (e *AkaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AkaEntity) Deleted() bool {
	return e.deleted
}


func (e *AkaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAkaEntity(e.client, opts)
}

func (e *AkaEntity) Data(args ...any) any {
...
func (e *AkaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Aka; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AkaEntity) DataTyped(data ...Aka) Aka {
	if len(data) > 0 {
		return typedFrom[Aka](e.Data(asMap(data[0])))
	}
	return typedFrom[Aka](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Aka (all fields
// optional at the wire level).
func (e *AkaEntity) MatchTyped(match ...Aka) Aka {
	if len(match) > 0 {
		return typedFrom[Aka](e.Match(asMap(match[0])))
	}
	return typedFrom[Aka](e.Match())
}
...
func (e *AkaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AkaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AkaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AkaListMatch and returns []Aka. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AkaEntity) ListTyped(reqmatch AkaListMatch, ctrl map[string]any) ([]Aka, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Aka](res), nil
}



func (e *AkaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AkaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AkaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AkaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
