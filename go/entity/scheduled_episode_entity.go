...
type ScheduledEpisodeEntity struct {
	name    string
...
func NewScheduledEpisodeEntity(client *core.TvmazeSDK, entopts map[string]any) *ScheduledEpisodeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScheduledEpisodeEntity) GetName() string { return e.name }
...
func (e *ScheduledEpisodeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScheduledEpisodeEntity) Deleted() bool {
	return e.deleted
}


func (e *ScheduledEpisodeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScheduledEpisodeEntity(e.client, opts)
}

func (e *ScheduledEpisodeEntity) Data(args ...any) any {
...
func (e *ScheduledEpisodeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ScheduledEpisode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScheduledEpisodeEntity) DataTyped(data ...ScheduledEpisode) ScheduledEpisode {
	if len(data) > 0 {
		return typedFrom[ScheduledEpisode](e.Data(asMap(data[0])))
	}
	return typedFrom[ScheduledEpisode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ScheduledEpisode (all fields
// optional at the wire level).
func (e *ScheduledEpisodeEntity) MatchTyped(match ...ScheduledEpisode) ScheduledEpisode {
	if len(match) > 0 {
		return typedFrom[ScheduledEpisode](e.Match(asMap(match[0])))
	}
	return typedFrom[ScheduledEpisode](e.Match())
}
...
func (e *ScheduledEpisodeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScheduledEpisodeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ScheduledEpisodeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScheduledEpisodeListMatch and returns []ScheduledEpisode. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ScheduledEpisodeEntity) ListTyped(reqmatch ScheduledEpisodeListMatch, ctrl map[string]any) ([]ScheduledEpisode, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ScheduledEpisode](res), nil
}



func (e *ScheduledEpisodeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScheduledEpisodeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScheduledEpisodeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScheduledEpisodeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
