...
func NewSeasonEntity(client *core.TvmazeSDK, entopts map[string]any) *SeasonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SeasonEntity) GetName() string { return e.name }
...
func (e *SeasonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SeasonEntity) Deleted() bool {
	return e.deleted
}


func (e *SeasonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSeasonEntity(e.client, opts)
}

func (e *SeasonEntity) Data(args ...any) any {
...
func (e *SeasonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Season; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SeasonEntity) DataTyped(data ...Season) Season {
	if len(data) > 0 {
		return typedFrom[Season](e.Data(asMap(data[0])))
	}
	return typedFrom[Season](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Season (all fields
// optional at the wire level).
func (e *SeasonEntity) MatchTyped(match ...Season) Season {
	if len(match) > 0 {
		return typedFrom[Season](e.Match(asMap(match[0])))
	}
	return typedFrom[Season](e.Match())
}
...
func (e *SeasonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SeasonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SeasonListMatch and returns []Season. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SeasonEntity) ListTyped(reqmatch SeasonListMatch, ctrl map[string]any) ([]Season, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Season](res), nil
}



func (e *SeasonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SeasonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SeasonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SeasonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
