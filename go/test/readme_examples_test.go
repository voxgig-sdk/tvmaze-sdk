...
const testSeed = `map[string]any{"entity": map[string]any{"aka": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "alternate_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cast": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cast_credit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cast_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "crew": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "crew_credit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "crew_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "guest_cast_credit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "scheduled_episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "season": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "show": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
