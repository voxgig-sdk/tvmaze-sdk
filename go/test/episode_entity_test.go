...
func episodeBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap := vs.Transform(
		[]any{"episode01", "episode02", "episode03", "season01", "season02", "season03", "show01", "show02", "show03"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("TVMAZE_TEST_EPISODE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["TVMAZE_TEST_EPISODE_ENTID"])
