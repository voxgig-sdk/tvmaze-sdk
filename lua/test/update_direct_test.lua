...
describe("UpdateDirect", function()
  it("should direct-load-update", function()
    local setup = update_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-update", setup.live and "live" or "unit")
