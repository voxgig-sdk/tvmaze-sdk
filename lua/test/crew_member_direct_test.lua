...
describe("CrewMemberDirect", function()
  it("should direct-list-crew_member", function()
    local setup = crew_member_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-crew_member", setup.live and "live" or "unit")
...
function crew_member_direct_setup(mockres)
