...
describe("ScheduledEpisodeDirect", function()
  it("should direct-list-scheduled_episode", function()
    local setup = scheduled_episode_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-scheduled_episode", setup.live and "live" or "unit")
...
function scheduled_episode_direct_setup(mockres)
