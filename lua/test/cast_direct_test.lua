...
describe("CastDirect", function()
  it("should direct-list-cast", function()
    local setup = cast_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cast", setup.live and "live" or "unit")
...
function cast_direct_setup(mockres)
