...
describe("CastCreditDirect", function()
  it("should direct-list-cast_credit", function()
    local setup = cast_credit_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cast_credit", setup.live and "live" or "unit")
...
function cast_credit_direct_setup(mockres)
