...
describe("AkaDirect", function()
  it("should direct-list-aka", function()
    local setup = aka_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-aka", setup.live and "live" or "unit")
...
function aka_direct_setup(mockres)
