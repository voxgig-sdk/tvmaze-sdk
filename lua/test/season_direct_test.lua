...
describe("SeasonDirect", function()
  it("should direct-list-season", function()
    local setup = season_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-season", setup.live and "live" or "unit")
...
function season_direct_setup(mockres)
