...
describe("CrewCreditDirect", function()
  it("should direct-list-crew_credit", function()
    local setup = crew_credit_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-crew_credit", setup.live and "live" or "unit")
...
function crew_credit_direct_setup(mockres)
