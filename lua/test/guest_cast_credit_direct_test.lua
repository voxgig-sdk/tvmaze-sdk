...
describe("GuestCastCreditDirect", function()
  it("should direct-list-guest_cast_credit", function()
    local setup = guest_cast_credit_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-guest_cast_credit", setup.live and "live" or "unit")
...
function guest_cast_credit_direct_setup(mockres)
