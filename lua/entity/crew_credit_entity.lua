...
local CrewCreditEntity = {}
CrewCreditEntity.__index = CrewCreditEntity


function CrewCreditEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CrewCreditEntity)
  self._name = "crew_credit"
  self._client = client
...
function CrewCreditEntity:get_name()
  return self._name
end


function CrewCreditEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CrewCreditEntity.new(self._client, opts)
end
...
function CrewCreditEntity:mark_deleted()
  self._deleted = true
end


function CrewCreditEntity:deleted()
  return true == self._deleted
end


function CrewCreditEntity:data_set(args)
  if args ~= nil then
...
function CrewCreditEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CrewCreditEntity:match_set(args)
  if args ~= nil then
...
function CrewCreditEntity:match_get()
...
function CrewCreditEntity:stream(action, args, callopts)
...
---@param reqmatch CrewCreditListMatch
---@param ctrl? table
---@return CrewCredit[]
---@return string? err
function CrewCreditEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CrewCreditEntity:_run_op(ctx, post_done)
  local utility = self._utility
