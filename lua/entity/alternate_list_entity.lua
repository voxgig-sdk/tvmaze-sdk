...
local AlternateListEntity = {}
AlternateListEntity.__index = AlternateListEntity


function AlternateListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AlternateListEntity)
  self._name = "alternate_list"
  self._client = client
...
function AlternateListEntity:get_name()
  return self._name
end


function AlternateListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AlternateListEntity.new(self._client, opts)
end
...
function AlternateListEntity:mark_deleted()
  self._deleted = true
end


function AlternateListEntity:deleted()
  return true == self._deleted
end


function AlternateListEntity:data_set(args)
  if args ~= nil then
...
function AlternateListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AlternateListEntity:match_set(args)
  if args ~= nil then
...
function AlternateListEntity:match_get()
...
function AlternateListEntity:stream(action, args, callopts)
...
function AlternateListEntity:_run_op(ctx, post_done)
  local utility = self._utility
