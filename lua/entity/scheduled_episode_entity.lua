...
local ScheduledEpisodeEntity = {}
ScheduledEpisodeEntity.__index = ScheduledEpisodeEntity


function ScheduledEpisodeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ScheduledEpisodeEntity)
  self._name = "scheduled_episode"
  self._client = client
...
function ScheduledEpisodeEntity:get_name()
  return self._name
end


function ScheduledEpisodeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ScheduledEpisodeEntity.new(self._client, opts)
end
...
function ScheduledEpisodeEntity:mark_deleted()
  self._deleted = true
end


function ScheduledEpisodeEntity:deleted()
  return true == self._deleted
end


function ScheduledEpisodeEntity:data_set(args)
  if args ~= nil then
...
function ScheduledEpisodeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ScheduledEpisodeEntity:match_set(args)
  if args ~= nil then
...
function ScheduledEpisodeEntity:match_get()
...
function ScheduledEpisodeEntity:stream(action, args, callopts)
...
---@param reqmatch ScheduledEpisodeListMatch
---@param ctrl? table
---@return ScheduledEpisode[]
---@return string? err
function ScheduledEpisodeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ScheduledEpisodeEntity:_run_op(ctx, post_done)
  local utility = self._utility
