...
local GuestCastCreditEntity = {}
GuestCastCreditEntity.__index = GuestCastCreditEntity


function GuestCastCreditEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GuestCastCreditEntity)
  self._name = "guest_cast_credit"
  self._client = client
...
function GuestCastCreditEntity:get_name()
  return self._name
end


function GuestCastCreditEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GuestCastCreditEntity.new(self._client, opts)
end
...
function GuestCastCreditEntity:mark_deleted()
  self._deleted = true
end


function GuestCastCreditEntity:deleted()
  return true == self._deleted
end


function GuestCastCreditEntity:data_set(args)
  if args ~= nil then
...
function GuestCastCreditEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GuestCastCreditEntity:match_set(args)
  if args ~= nil then
...
function GuestCastCreditEntity:match_get()
...
function GuestCastCreditEntity:stream(action, args, callopts)
...
function GuestCastCreditEntity:_run_op(ctx, post_done)
  local utility = self._utility
