...
module TvmazeTestRunner
  ...
  def self.env_override(m)
    live = getenv("TVMAZE_TEST_LIVE")
    override = getenv("TVMAZE_TEST_OVERRIDE")
    ...
    explain = getenv("TVMAZE_TEST_EXPLAIN")
    m["TVMAZE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = TvmazeTestRunner
Helpers = TvmazeHelpers
Vs = VoxgigStruct
