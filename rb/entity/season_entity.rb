...
class SeasonEntity
  ...
  # @return [Season, Hash] the current Season data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Season fields)
  def match_get
  ...
  #
  # @param reqmatch [SeasonListMatch, Hash, nil] match filter (any subset of
  #   Season fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Season>, Array] the matching Season items; raises TvmazeError on failure
