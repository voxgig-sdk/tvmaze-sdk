...
class CrewCreditEntity
  ...
  def make
    opts = @_entopts.dup
    CrewCreditEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CrewCreditListMatch, Hash, nil] match filter (any subset of
  #   CrewCredit fields); defaults to nil, treated as an empty match that lists all.
