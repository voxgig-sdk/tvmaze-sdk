...
class ScheduledEpisodeEntity
  ...
  def make
    opts = @_entopts.dup
    ScheduledEpisodeEntity.new(@_client, opts)
  end
  ...
  # @return [ScheduledEpisode, Hash] the current ScheduledEpisode data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ScheduledEpisode fields)
  def match_get
  ...
  #
  # @param reqmatch [ScheduledEpisodeListMatch, Hash, nil] match filter (any subset of
  #   ScheduledEpisode fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ScheduledEpisode>, Array] the matching ScheduledEpisode items; raises TvmazeError on failure
