...
class CastCreditEntity
  ...
  def make
    opts = @_entopts.dup
    CastCreditEntity.new(@_client, opts)
  end
  ...
  # @return [CastCredit, Hash] the current CastCredit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CastCredit fields)
  def match_get
  ...
  #
  # @param reqmatch [CastCreditListMatch, Hash, nil] match filter (any subset of
  #   CastCredit fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CastCredit>, Array] the matching CastCredit items; raises TvmazeError on failure
