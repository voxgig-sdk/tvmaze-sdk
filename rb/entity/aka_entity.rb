...
class AkaEntity
  ...
  #
  # @param reqmatch [AkaListMatch, Hash, nil] match filter (any subset of
  #   Aka fields); defaults to nil, treated as an empty match that lists all.
