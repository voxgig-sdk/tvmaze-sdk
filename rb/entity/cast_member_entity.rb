...
class CastMemberEntity
  ...
  def make
    opts = @_entopts.dup
    CastMemberEntity.new(@_client, opts)
  end
  ...
  # @return [CastMember, Hash] the current CastMember data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CastMember fields)
  def match_get
  ...
  #
  # @param reqmatch [CastMemberListMatch, Hash, nil] match filter (any subset of
  #   CastMember fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CastMember>, Array] the matching CastMember items; raises TvmazeError on failure
