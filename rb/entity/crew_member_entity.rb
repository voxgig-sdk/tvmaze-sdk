...
class CrewMemberEntity
  ...
  def make
    opts = @_entopts.dup
    CrewMemberEntity.new(@_client, opts)
  end
  ...
  # @return [CrewMember, Hash] the current CrewMember data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CrewMember fields)
  def match_get
  ...
  #
  # @param reqmatch [CrewMemberListMatch, Hash, nil] match filter (any subset of
  #   CrewMember fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CrewMember>, Array] the matching CrewMember items; raises TvmazeError on failure
