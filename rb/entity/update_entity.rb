...
class UpdateEntity
  ...
  #
  # @param reqmatch [UpdateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Update.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Update, Hash] the loaded Update; raises TvmazeError on failure
