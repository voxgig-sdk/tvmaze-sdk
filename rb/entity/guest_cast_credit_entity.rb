...
class GuestCastCreditEntity
  ...
  def make
    opts = @_entopts.dup
    GuestCastCreditEntity.new(@_client, opts)
  end
  ...
  # @return [GuestCastCredit, Hash] the current GuestCastCredit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GuestCastCredit fields)
  def match_get
  ...
  #
  # @param reqmatch [GuestCastCreditListMatch, Hash, nil] match filter (any subset of
  #   GuestCastCredit fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GuestCastCredit>, Array] the matching GuestCastCredit items; raises TvmazeError on failure
