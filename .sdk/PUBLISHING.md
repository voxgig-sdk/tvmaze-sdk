...
|---|---|---|
| `ts/` | @voxgig-sdk/tvmaze-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/tvmaze-sdk \
      --repository voxgig-sdk/tvmaze-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/tvmaze-sdk` shows it, and
`npm trust revoke @voxgig-sdk/tvmaze-sdk --id=<id>` removes it.
