...
from projectname_sdk import TvmazeSDK
from projectname_sdk.core.spec import TvmazeSpec
from projectname_sdk.core.result import TvmazeResult
from projectname_sdk.core.response import TvmazeResponse
from projectname_sdk.core.operation import TvmazeOperation
from projectname_sdk.core.error import TvmazeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TvmazeBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = TvmazeSDK.test(None, None)
        ...
        class TestInitFeature(TvmazeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TvmazeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TvmazeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TvmazeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TvmazeSDK.test(None, setup_opts)
