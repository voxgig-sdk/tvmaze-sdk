...
class TvmazeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TvmazeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TvmazeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TvmazeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
