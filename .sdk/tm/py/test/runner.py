...
class TvmazeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TvmazeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TvmazeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TvmazeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
