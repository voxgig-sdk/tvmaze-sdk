...
from projectname_sdk.core.control import TvmazeControl
...
class TvmazeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TvmazeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TvmazeError(code, msg, self)
