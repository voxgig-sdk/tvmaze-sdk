...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = TvmazeOmni.make_runner(TEST_JSON_FILE, TvmazeSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : TvmazeOmni.errify(err)
    end
