...
class TvmazeStreamingFeature extends TvmazeBaseFeature
{
    ...
    private function _iterate(TvmazeResult $result): \Generator
    {
    ...
    private function _streamable(TvmazeContext $ctx): bool
    {
