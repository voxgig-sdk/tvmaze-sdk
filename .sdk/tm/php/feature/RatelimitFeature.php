...
class TvmazeRatelimitFeature extends TvmazeBaseFeature
{
    ...
    private function _acquire(TvmazeContext $ctx): void
    {
    ...
    private function _track(TvmazeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
