...
// Tvmaze SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TvmazeTestFeature extends TvmazeBaseFeature
{
    ...
    public function init(TvmazeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TvmazeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TvmazeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TvmazeContext $ctx, $op, $args): array
    {
