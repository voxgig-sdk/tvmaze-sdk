...
class TvmazeCacheFeature extends TvmazeBaseFeature
{
    ...
    private function _through(TvmazeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
