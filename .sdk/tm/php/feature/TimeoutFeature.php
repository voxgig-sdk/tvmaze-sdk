...
class TvmazeTimeoutFeature extends TvmazeBaseFeature
{
    ...
    private function _with_timeout(TvmazeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TvmazeContext $_ctx, float $ms): void
    {
        $client = $this->client;
