...
// Tvmaze SDK clienttrack feature
...
class TvmazeClienttrackFeature extends TvmazeBaseFeature
{
    ...
    public function PostConstruct(TvmazeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Tvmaze-SDK';
