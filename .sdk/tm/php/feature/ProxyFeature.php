...
class TvmazeProxyFeature extends TvmazeBaseFeature
{
    ...
    public function init(TvmazeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TvmazeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
