...
class TvmazeNetsimFeature extends TvmazeBaseFeature
{
    ...
    private function _simulate(TvmazeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TvmazeContext $ctx, array $applied): void
    {
        $client = $this->client;
