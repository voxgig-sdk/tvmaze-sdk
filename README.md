...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/tvmaze` | `npm install @voxgig-sdk/tvmaze` |
| Python | `voxgig-sdk-tvmaze` | `pip install voxgig-sdk-tvmaze` |
| PHP | `voxgig-sdk/tvmaze` | `composer require voxgig-sdk/tvmaze` |
| Golang | `github.com/voxgig-sdk/tvmaze-sdk/go` | `go get github.com/voxgig-sdk/tvmaze-sdk/go` |
| Ruby | `voxgig-sdk-tvmaze` | `gem install voxgig-sdk-tvmaze` |
| Lua | `voxgig-sdk-tvmaze` | `luarocks install voxgig-sdk-tvmaze` |
