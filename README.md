...
Add television information to your own website or app with a fast and clean TV API.

Learn more about TVmaze API at [tvmaze.com](https://tvmaze.com).
...
This SDK exposes the API as a small set of **semantic entities** — Aka, AlternateList, Cast, CastCredit, CastMember, Crew, CrewCredit, CrewMember, Episode, GuestCastCredit, Image, Person, Schedule, ScheduledEpisode, Search, Season, Show and Update — that you
...
| Go CLI | `github.com/voxgig-sdk/tvmaze-sdk/go-cli` | `go install github.com/voxgig-sdk/tvmaze-sdk/go-cli/cmd/tvmaze@latest` |
| Go MCP server | `github.com/voxgig-sdk/tvmaze-sdk/go-mcp` | `go get github.com/voxgig-sdk/tvmaze-sdk/go-mcp@latest` |
