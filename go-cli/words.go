...
func registerSDKWords(r *eng.Registry, client *sdk.TvmazeSDK) {
...
func runOp(client *sdk.TvmazeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
