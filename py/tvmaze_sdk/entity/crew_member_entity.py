...
class CrewMemberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CrewMemberEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CrewMember]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CrewMember().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
