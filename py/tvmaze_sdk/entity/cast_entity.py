...
class CastEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CastEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Cast]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Cast().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
