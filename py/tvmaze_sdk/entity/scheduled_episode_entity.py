...
class ScheduledEpisodeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ScheduledEpisodeEntity(self._client, opts)
    ...
    def data_get(self) -> ScheduledEpisode:
    ...
    def match_get(self) -> ScheduledEpisode:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ScheduledEpisode]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ScheduledEpisode().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
