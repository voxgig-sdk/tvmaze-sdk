...
class GuestCastCreditEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GuestCastCreditEntity(self._client, opts)
    ...
    def data_get(self) -> GuestCastCredit:
    ...
    def match_get(self) -> GuestCastCredit:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GuestCastCredit]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GuestCastCredit().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
