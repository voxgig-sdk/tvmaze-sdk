...
from tvmaze_sdk.utility import register

# Load features
from tvmaze_sdk.feature.base_feature import TvmazeBaseFeature
from tvmaze_sdk.features import _has_feature, _make_feature
...
class TvmazeSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "TvmazeSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TvmazeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Aka(self, data=None) -> "AkaEntity":
        ...
        from tvmaze_sdk.entity.aka_entity import AkaEntity
    ...
    def AlternateList(self, data=None) -> "AlternateListEntity":
        ...
        from tvmaze_sdk.entity.alternate_list_entity import AlternateListEntity
    ...
    def Cast(self, data=None) -> "CastEntity":
        ...
        from tvmaze_sdk.entity.cast_entity import CastEntity
    ...
    def CastCredit(self, data=None) -> "CastCreditEntity":
        ...
        from tvmaze_sdk.entity.cast_credit_entity import CastCreditEntity
    ...
    def CrewCredit(self, data=None) -> "CrewCreditEntity":
        ...
        from tvmaze_sdk.entity.crew_credit_entity import CrewCreditEntity
    ...
    def CrewMember(self, data=None) -> "CrewMemberEntity":
        ...
        from tvmaze_sdk.entity.crew_member_entity import CrewMemberEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from tvmaze_sdk.entity.episode_entity import EpisodeEntity
    ...
    def GuestCastCredit(self, data=None) -> "GuestCastCreditEntity":
        ...
        from tvmaze_sdk.entity.guest_cast_credit_entity import GuestCastCreditEntity
    ...
    def Image(self, data=None) -> "ImageEntity":
        ...
        from tvmaze_sdk.entity.image_entity import ImageEntity
    ...
    def Person(self, data=None) -> "PersonEntity":
        ...
        from tvmaze_sdk.entity.person_entity import PersonEntity
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from tvmaze_sdk.entity.schedule_entity import ScheduleEntity
