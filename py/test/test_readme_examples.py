# Tvmaze SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TvmazeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TvmazeSDK(...) and TvmazeSDK.test(...) become
#      TvmazeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tvmaze_sdk"
_SDK_CLASS = "TvmazeSDK"
...
_ENTITIES = {
    ...
    "Cast": "cast",
    "CastCredit": "cast_credit",
    "CastMember": "cast_member",
    "Crew": "crew",
    "CrewCredit": "crew_credit",
    "CrewMember": "crew_member",
    "Episode": "episode",
    "GuestCastCredit": "guest_cast_credit",
    "Image": "image",
    "Person": "person",
    "Schedule": "schedule",
    "ScheduledEpisode": "scheduled_episode",
    "Search": "search",
    "Season": "season",
    "Show": "show",
    "Update": "update",
