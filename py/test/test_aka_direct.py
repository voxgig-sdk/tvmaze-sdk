...
class TestAkaDirect:
    ...
    def test_should_direct_list_aka(self):
        setup = _aka_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-aka", "live" if setup["live"] else "unit")
        if _skip:
