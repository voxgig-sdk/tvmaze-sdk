...
class TestScheduledEpisodeEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.ScheduledEpisode(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.ScheduledEpisode(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        scheduled_episode_ref01_list_result = scheduled_episode_ref01_ent.list(scheduled_episode_ref01_match, None)
